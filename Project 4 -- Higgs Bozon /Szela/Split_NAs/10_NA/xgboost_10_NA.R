...
setwd("~/GitHub-kszela24/higgs-bozon/Szela/Split_NAs/10_NA")

#Reading in training and testing data.
train = as.data.frame(read.csv("train_10_NA.csv"))
test = as.data.frame(read.csv("test_10_NA.csv"))
...
write.csv(to_save, "predictions_10_NA_weighted.csv", row.names = F)