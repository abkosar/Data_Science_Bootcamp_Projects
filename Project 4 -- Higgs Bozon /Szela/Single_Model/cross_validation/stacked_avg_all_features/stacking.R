...
foreach(i=1:length(idx)) %dopar% {
  ...
  for_stack_test = paste0("stack_", i, "_1111_test.csv")
  for_stack_train = paste0("stack_", i, "_1111_train.csv")
  sub_file = paste0("cv_", i, "_1111.csv")
  sol_file = paste0("solution_cv_", i, "_1111.csv")
...
train.cv.extra = rbind(as.data.frame(read.csv("stack_1_1111_train.csv")),
                       as.data.frame(read.csv("stack_2_1111_train.csv")),
                       as.data.frame(read.csv("stack_3_1111_train.csv")),
                       as.data.frame(read.csv("stack_4_1111_train.csv")),
                       as.data.frame(read.csv("stack_5_1111_train.csv")))

test.preds1 = as.data.frame(read.csv("stack_1_1111_test.csv"))
test.preds2 = as.data.frame(read.csv("stack_2_1111_test.csv"))
test.preds3 = as.data.frame(read.csv("stack_3_1111_test.csv"))
test.preds4 = as.data.frame(read.csv("stack_4_1111_test.csv"))
test.preds5 = as.data.frame(read.csv("stack_5_1111_test.csv"))
...
write.csv(train.cv.extra, "predictions_stacked_1111_train.csv", row.names = F)
...
write.csv(submission, "predictions_stacked_1111_test.csv", row.names = F)
write.csv(submission_sorted, "submission_stacked_1111.csv", row.names = F)