...
foreach(i=1:length(idx)) %dopar% {
  ...
  for_stack_test = paste0("stack_", i, "_0_test.csv")
  for_stack_train = paste0("stack_", i, "_0_train.csv")
  sub_file = paste0("cv_", i, "_0.csv")
  sol_file = paste0("solution_cv_", i, "_0.csv")
...
train.cv.extra = rbind(as.data.frame(read.csv("stack_1_0_train.csv")),
                       as.data.frame(read.csv("stack_2_0_train.csv")),
                       as.data.frame(read.csv("stack_3_0_train.csv")),
                       as.data.frame(read.csv("stack_4_0_train.csv")),
                       as.data.frame(read.csv("stack_5_0_train.csv")))

test.preds1 = as.data.frame(read.csv("stack_1_0_test.csv"))
test.preds2 = as.data.frame(read.csv("stack_2_0_test.csv"))
test.preds3 = as.data.frame(read.csv("stack_3_0_test.csv"))
test.preds4 = as.data.frame(read.csv("stack_4_0_test.csv"))
test.preds5 = as.data.frame(read.csv("stack_5_0_test.csv"))
