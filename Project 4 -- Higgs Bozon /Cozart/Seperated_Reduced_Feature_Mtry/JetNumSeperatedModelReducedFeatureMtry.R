...
set.seed(1)
rf1 = randomForest(Label ~ ., data = jetnumtrain0, importance = TRUE, mtry=3)
rf1
...
set.seed(1)
rf2 = randomForest(Label ~ ., data = jetnumtrain1, importance = TRUE, mtry = 12)
rf2
...
set.seed(1)
rf3 = randomForest(Label ~ ., data = jetnumtrain23, importance = TRUE, mtry =7)
rf3
...
write.csv(submission, "rfjetnum_submissionReducedFeatureMtry2seed.csv", row.names=FALSE)
...
write.csv(submission, "rfjetnum_submissionReducedFeatureMtryseed.csv", row.names=FALSE)
