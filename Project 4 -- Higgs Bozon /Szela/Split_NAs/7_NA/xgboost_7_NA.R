...
setwd("~/GitHub-kszela24/higgs-bozon/Szela/Split_NAs/7_NA")

#Reading in training and testing data.
train = as.data.frame(read.csv("train_7_NA.csv"))
test = as.data.frame(read.csv("test_7_NA.csv"))
...
write.csv(to_save, "predictions_7_NA_weighted.csv", row.names = F)