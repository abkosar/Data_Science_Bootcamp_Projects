...
setwd("~/GitHub-kszela24/higgs-bozon/Szela/NA_DER_mass_jet_jet")

#Reading in training and testing data.
train = as.data.frame(read.csv("train_NA_DER_mass_jet_jet.csv"))
test = as.data.frame(read.csv("test_NA_DER_mass_jet_jet.csv"))
