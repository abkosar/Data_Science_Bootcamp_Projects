...
setwd("~/GitHub-kszela24/higgs-bozon/Szela/no_NA")

#Reading in training and testing data.
train = as.data.frame(read.csv("train_no_NA.csv"))
test = as.data.frame(read.csv("test_no_NA.csv"))
