...
setwd("~/GitHub-kszela24/higgs-bozon/Szela/Split_NAs/1_NA")

#Reading in training and testing data.
train = as.data.frame(read.csv("train_1_NA.csv"))
test = as.data.frame(read.csv("test_1_NA.csv"))
...
write.csv(to_save, "predictions_1_NA_weighted.csv", row.names = F)
