...
setwd("~/GitHub-kszela24/higgs-bozon/Szela/Split_NAs/11_NA")

#Reading in training and testing data.
train = as.data.frame(read.csv("train_11_NA.csv"))
test = as.data.frame(read.csv("test_11_NA.csv"))
...
write.csv(to_save, "predictions_11_NA_weighted.csv", row.names = F)